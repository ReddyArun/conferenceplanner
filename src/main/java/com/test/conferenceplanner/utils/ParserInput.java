...
import com.test.conferenceplanner.Talk;
...
public class ParserInput {
	...
	final static Logger logger = Logger.getLogger(ParserInput.class);
	private static final String LIGHTNING = "lightning";
	private static final int LIGHTNING_DURATION = 5;

	/**
	 * Takes an input file and parses it into Talk objects. Talk objects are
	 * extracted by Conference objects and arranged into tracks.
	 * 
	 * @param inputFile
	...
	/**
	 * Read input file line by line and convert the information into Talk
	 * objects.
	 * 
	...
	private static ArrayList<Talk> parseToTalks(BufferedReader bufferedReader) throws FileFormatException {
		...
		try {
			...
			while (s.hasNextLine()) {
				...
				// Split title and duration from the index of the first integer
				// in the line.
